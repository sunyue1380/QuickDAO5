...
import cn.schoolwow.quickdao.dao.statement.query.GetConditionResponseArraySQLStatement;
...
public class ParametersUtil {
     ...
     * 获取查询拼接SQL语句
     */
    public static String getConditionResponseArraySQLStatement(Query query) {
        DatabaseStatementOption databaseStatementOption = new DatabaseStatementOption();
        databaseStatementOption.query = query;
        DatabaseStatement getConditionResponseArraySQLStatement = new GetConditionResponseArraySQLStatement(databaseStatementOption, query.quickDAOConfig);
        return getConditionResponseArraySQLStatement.getStatement();
    }
     ...
     * @param parameters 参数
     */
    public static String replaceStatementPlaceholder(String sql, Collection parameters) { StringBuilder sqlBuilder = new StringBuilder(sql.replace("?", PLACEHOLDER));
