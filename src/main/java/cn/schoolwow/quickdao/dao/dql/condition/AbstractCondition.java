...
public class AbstractCondition<T> implements Condition<T>, Serializable, Cloneable {
    ...
    public Condition<T> addSubQuery(String field, String operator, Condition subQuery) {
        ...
        subQuery.execute();
        whereList.add(new FieldFragmentEntry(field, " {} " + operator + " (" + ParametersUtil.getConditionResponseArraySQLStatement(abstractCondition.query) + ")"));
    ...
    public Condition<T> addColumn(Condition subQuery) {
        ...
        columnList.add("( " + ParametersUtil.getConditionResponseArraySQLStatement(selectQuery) + ")");
    ...
    public Condition<T> addColumn(Condition subQuery, String columnNameAlias) {
        ...
        columnList.add("( " + ParametersUtil.getConditionResponseArraySQLStatement(selectQuery) + ") " + columnNameAlias);
    ...
    public Condition<T> having(String field, String operator, Condition subQuery) {
        ...
        subQuery.execute();
        havingList.add(new FieldFragmentEntry(field, "{}" + operator + " (" + ParametersUtil.getConditionResponseArraySQLStatement(abstractCondition.query) + ")"));
        this.query.parameterList.addAll(abstractCondition.query.parameterList);
        return this;
    }
    ...
    public <E> SubCondition<E, T> joinTable(Condition<E> joinCondition, String primaryField, String joinConditionField) {
        ...
        subQuery.subQuerySQLBuilder = new StringBuilder(ParametersUtil.getConditionResponseArraySQLStatement(joinQuery));
    ...
    private void addExistSubQuery(Condition subQuery, String exist) {
        ...
        subQuery.execute();
        whereList.add(new FieldFragmentEntry(IGNORE, exist + " (" + ParametersUtil.getConditionResponseArraySQLStatement(abstractCondition.query) + ")"));
        this.query.parameterList.addAll(abstractCondition.query.parameterList);
    }
