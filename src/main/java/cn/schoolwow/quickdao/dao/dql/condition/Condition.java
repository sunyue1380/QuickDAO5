...
public interface Condition<T> extends Serializable {
    ...
    /**
     * 自定义查询语句,具体映射规则请看此{@link cn.schoolwow.quickdao.dao.dql.condition.Condition}
     *
     ...
     */
    Condition<T> excludeColumn(String... excludeFields);
     ...
     */
    Condition<T> setColumnTypeMapping(Function<Property, Class> queryColumnTypeMapping);
    ...
    /**
     * 添加更新字段,用于{@link cn.schoolwow.quickdao.dao.dql.response.Response#update()}方法
     *
     * @param field 待更新的字段
     * @param value 待更新字段的值
     */
    ...
    /**
     * 添加or查询,具体映射规则请看此{@link cn.schoolwow.quickdao.dao.dql.condition.Condition}
     *
     ...
     * 返回子表实体类字段信息
     *
     * @see {@link cn.schoolwow.quickdao.dao.dql.condition.Condition#joinTable(Class, String, String)} ()}
     * @see {@link cn.schoolwow.quickdao.dao.dql.condition.Condition#joinTable(Class, String, String, String)} ()}
     */
